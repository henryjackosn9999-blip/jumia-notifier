...
SHOPS = [
    {
        "name":          "Meliverse agencies",
        "client_id":     "18bddd88-1701-40fc-b0d7-097c1ea0b99e",
        "refresh_token": "xupUbfxQuAbOJFFFOgxuIP3aqen5vewOhUveIsAzp4E",
    },
    {
        "name":          "Cager enterprises",
        "client_id":     "59be32fa-7f1a-4fbf-a321-5048278c615c",
        "refresh_token": "Ez3fxhZ_qyfOa2-YmC-UfKbEybXPs38Wdq5UIQAXy5c",
    },
    {
        "name":          "Ngeno enterprises",
        "client_id":     "072e8e59-08dc-49f1-bbec-5640cddc8f33",
        "refresh_token": "mUozvPQt_14HD_DTcitFl86owwaIVq1TQhAaG7hyZnw",
    },
    {
        "name":          "Dalia enterprise",
        "client_id":     "99513fdc-420e-4e1d-86d3-12acbc581279",
        "refresh_token": "wLgBkqN-mhxL6uuRbOLtp_II70ONjRvccySBBIWwFmQ",
    },
    {
        "name":          "sharkdeals enterprises",
        "client_id":     "27991cab-dd21-4ae0-8963-6b272845b0eb",
        "refresh_token": "UGEM6eS3vKd7Holl7fJKDQ5gIK4C_AwxhiVWzbbSP3s",
    },
    {
        "name":          "andanu enterprises",
        "client_id":     "72a85890-42d4-4c6f-a16c-faab8d19d80d",
        "refresh_token": "dKhf1wvCXn7korzkBsjdZBxHFdD1Kiau-sG7YIQJvLY",
    },
    {
        "name":          "amalia enterprises",
        "client_id":     "764184a9-d2e1-4650-afa5-bb3c597e59d2",
        "refresh_token": "7aMRVLoCVCBbVEBtmXOeCBlNGpTfPz_5oAwXjUdgf74",
    },
]
...
def main():
    ...
    send_telegram(
        ...
        + "\n".join(f"  • {s['name']}" for s in SHOPS) +
        f"\n\n⏱ Checking every <b>{CHECK_INTERVAL}s</b>\n\n"
